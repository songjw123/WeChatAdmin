	...
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			...
			<a href="#" class="navbar-brand"> <small> <i
					class="fa fa-leaf"></i>网上商城管理后台</small> </a>
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								<li><a href="#" class="clearfix"> <img
										src="http://ace.zcdreams.com/assets/avatars/avatar.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="http://ace.zcdreams.com/assets/avatars/avatar3.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="http://ace.zcdreams.com/assets/avatars/avatar4.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="http://ace.zcdreams.com/assets/avatars/avatar2.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="http://ace.zcdreams.com/assets/avatars/avatar5.png" class="msg-photo"
